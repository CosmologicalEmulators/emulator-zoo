...
folder_output = "/farmdisk1/mbonici/trained_effort_velocileptors_rept_mnuOkcdm_10000"
for ell in ells
    for component in components
        # Construct the bsub command
        bsub_command = `bsub -P c7 -q long -o /home/mbonici/emulator-zoo/Effort.jl/velocileptors_rept_mnuOkcdm/job.out \
                            -e /home/mbonici/emulator-zoo/Effort.jl/velocileptors_rept_mnuOkcdm/job.err -n 8 -M 6100 \
                            ...
                            julia -t 8 --project=/home/mbonici/emulator-zoo/Effort.jl/velocileptors_rept_mnuOkcdm \
                            /home/mbonici/emulator-zoo/Effort.jl/velocileptors_rept_mnuOkcdm/trainer.jl \
                            --component $component -l $ell \
                            -i /farmdisk1/mbonici/effort_velocileptors_rept_mnuOkcdm_10000 \
                            -o $folder_output`
