...
preconditioning = "noprec"
n_input = "20000"
input = "/farmdisk1/mbonici/effort_pybird_mnulcdm_" * n_input

for iteration in iterations
    folder_output = "/farmdisk1/mbonici/trained_effort_pybird_mnulcdm/trained_pybird_mnulcdm_" * n_input * "/" * preconditioning * "/" * iteration
    for ell in ells
