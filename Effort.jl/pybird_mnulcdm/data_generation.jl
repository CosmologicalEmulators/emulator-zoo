...
addprocs_lsf(40; bsub_flags=`-q long -n 1 -M 4094 -e /home/mbonici/emulator-zoo/Effort.jl/mnulcdm/job.err`)#this because I am using a lsf cluster. Use the appropriate one!
@everywhere using PyCall
@everywhere begin
    using NPZ, EmulatorsTrainer, JSON3, Random, PyCall
    pars = ["z", "ln10As", "ns", "H0", "ombh2", "omch2", "Mν"]
    lb = [0.25, 2.5, 0.8, 50.0, 0.02, 0.08, 0.0]
    ub = [2.0, 3.5, 1.10, 80.0, 0.025, 0.2, 0.5]
    ...
    root_dir = "/farmdisk1/mbonici/effort_pybird_mnulcdm_" * string(n)#this is tuned to my dir, use the right one for you!
