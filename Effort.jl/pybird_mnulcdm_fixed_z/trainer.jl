...
function get_observable_tuple(cosmo_pars, Pk)
    ...
    return (cosmo_pars["ln10As"], cosmo_pars["ns"], cosmo_pars["H0"],
...
df = DataFrame(ln10A_s=Float64[], ns=Float64[], H0=Float64[], omega_b=Float64[], omega_cdm=Float64[], Mν=Float64[], observable=Array[])
