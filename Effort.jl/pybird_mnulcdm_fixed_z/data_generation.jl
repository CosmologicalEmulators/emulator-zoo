...
@everywhere begin
    ...
    pars = ["ln10As", "ns", "H0", "ombh2", "omch2", "Mν"]
    lb = [2.5, 0.8, 50.0, 0.02, 0.08, 0.0]
    ub = [3.5, 1.10, 80.0, 0.025, 0.2, 0.5]
    ...
    root_dir = "/farmdisk1/mbonici/effort_pybird_mnulcdm_fixed_z_" * string(n)#this is tuned to my dir, use the right one for you!
