...
addprocs_lsf(5; bsub_flags=`-q long -n 1 -M 4094 -e /home/mbonici/emulator-zoo/Effort.jl/velocileptors_rept_mnuw0wacdm/job.err`, exeflags="--project=/home/mbonici/emulator-zoo/Effort.jl/velocileptors_rept_mnuw0wacdm")#this because I am using a lsf cluster. Use the appropriate one!
...
@everywhere begin
    ...
    EPT = pyimport("velocileptors.EPT.ept_fullresum_fftw")
    ...
    root_dir = "/farmdisk1/mbonici/effort_velocileptors_rept_mnuw0wacdm_" * string(n)#this is tuned to my dir, use the right one for you!
    ...
    function velocileptors_script(CosmoDict, root_path)
        try
            ...
            PT = EPT.REPT(knw, plin, pnw=Pnw, kmin=5e-4, kmax=0.5, nk=80,
