...
ells = [0, 2, 4]
folder_output = "/farmdisk1/mbonici/trained_effort_pybird_mnuw0wacdm_2000"
for ell in ells
    for component in components
        # Construct the bsub command
        bsub_command = `bsub -P c7 -q medium -o /home/mbonici/emulator-zoo/Effort.jl/pybird_mnuw0wacdm/job.out \
                            -e /home/mbonici/emulator-zoo/Effort.jl/pybird_mnuw0wacdm/job.err -n 8 -M 12000 \
                            ...
                            -i /farmdisk1/mbonici/effort_pybird_mnuw0wacdm_2000 \
                            -o $folder_output
                            -p AsDzprec`
