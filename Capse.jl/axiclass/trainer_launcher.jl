spectra = ["TT", "TE", "EE"]
input = "/farmdisk1/mbonici/capse_axiclass_120000"
output = "/farmdisk1/mbonici/trained_capse_axiclass_120000"

for spectrum in spectra
    # Construct the bsub command
    folder_output = output
    bsub_command = `bsub -P c7 -q long -o /home/mbonici/emulator-zoo/Capse.jl/axiclass/job.out \
                        -e /home/mbonici/emulator-zoo/Capse.jl/axiclass/job.err -n 8 -M 12000 \
                        ...
                        julia -t 8 --project=/home/mbonici/emulator-zoo/Capse.jl/axiclass \
