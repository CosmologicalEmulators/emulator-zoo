...
const LOWER_BOUNDS = [2.5, 0.85, 0.02, 50.0, 0.02, 0.08]
const UPPER_BOUNDS = [3.5, 1.05, 0.15, 90.0, 0.025, 0.16]
const DESIGN_SEED = 20260732
...
metadata = Dict(
    ...
    "fixed_parameters" => Dict("Mnu" => 0.06, "w0" => -1.0, "wa" => 0.0),
)
